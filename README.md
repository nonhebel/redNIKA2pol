...
Below is an example from the DYNAMAG sample which showcases the importance of IP correction (Nonhebel et al. in prep). While the vectors are unchanged in the diffuse regions, at the intensity peaks clear differences are apparent in the inferred direction of the magnetic field. IP correction will thus have a large impact on the results of your observations and should be done with care! Good luck on your quest for leakage-free maps.
