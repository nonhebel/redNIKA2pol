...
setup_target() {
    ...
    safe_copy "scripts/01_general/source_reduction_convergence.py" "reductions/$target/01_general/${target}_reduction_convergence.py"
    ...
    safe_copy "scripts/02_individual/source_a13_save_ind.piic" "reductions/$target/02_individual/${target}_a13_save_ind.piic"
    ...
    safe_copy "scripts/03_corr/combine_maps.piic" "reductions/$target/03_corr/combine_maps.piic"
    safe_copy "scripts/03_corr/corr_instr_pol.piic" "reductions/$target/03_corr/corr_instr_pol.piic"
    safe_copy "scripts/03_corr/source_ip_corr_MP.py" "reductions/$target/03_corr/${target}_ip_corr_MP.py"
    ...
    safe_copy "scripts/04_bootstrap/combine_maps.piic" "reductions/$target/04_bootstrap/combine_maps.piic"
    safe_copy "scripts/04_bootstrap/bsm.piic" "reductions/$target/04_bootstrap/bsm.piic"
    safe_copy "scripts/04_bootstrap/source_bootstrap_err.py" "reductions/$target/04_bootstrap/${target}_bootstrap_err.py"
    safe_copy "scripts/04_bootstrap/source_bootstrap_convergence.py" "reductions/$target/04_bootstrap/${target}_bootstrap_convergence.py"
 
    # 05_products
    mkdir -p "reductions/$target/05_products"
    safe_copy "scripts/05_products/bsm.piic" "reductions/$target/05_products/bsm.piic"
    safe_copy "scripts/05_products/creaRMS_IQU.piic" "reductions/$target/05_products/creaRMS_IQU.piic"
    safe_copy "scripts/05_products/source_create_products.py" "reductions/$target/05_products/${target}_create_products.py"
    safe_copy "scripts/05_products/source_uncorrected_v_corrected.py" "reductions/$target/05_products/${target}_uncorrected_v_corrected.py"
    echo "Set up $target"
}
